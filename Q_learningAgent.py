...
class TradingBot:
    ...
    def _build_model(self, hidden_units, learning_rate, dropout):
        """Method to creare the DNN model."""
        model = Sequential()
        model.add(Dense(hidden_units, input_shape=(self.learn_env.lags,
    ...
    def replay(self):
        """Method to retrain the DNN model based on batches of memorized experiences."""
        ...
        for _ in range(10000):
            ...
            if done:
                ...
                if e % int(episodes / 6) == 0:
                    ...
                    templ += "trward: {:4d} | perf: {:5.3f} | eps: {:.2f}\n"
                    templ += 71 * '='
...
def plot_trward(agent):
    """Function to plot the total reward per trainig episode."""
...
def plot_performance(agent):
    """Function to plot the financial gross performance per trainig episode."""
